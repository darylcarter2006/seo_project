...
NOTE: If this file already has content in the real repo (e.g. blueprint
registration from routes/), merge this with that rather than overwrite --
the important pieces are: db.init_app(app), importing app.models before
init_db() runs, and calling init_db(app).
"""
